                    ...
                    <div id="accordion-2" class="accordion accordion-faq">
                        ...
                        <div class="card">
                            ...
                            <div id="collapse-2-10" class="collapse" aria-labelledby="heading-2-10"
                                 data-parent="#accordion-2">
                                <div class="card-body">
                                    <p>Yes you can make as many deposit as you want on any of our investment plans except the Starter Plan where you can only invest two times. And you can only withdraw once in the Starter plan.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Accordion card 3 -->
